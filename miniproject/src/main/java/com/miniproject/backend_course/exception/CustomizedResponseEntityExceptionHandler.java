...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleInterviewerNotFoundException(InterviewerNotFoundException ex,
			WebRequest request) {
	...
	public final ResponseEntity<Object> handleIntervieweeNotFoundException(IntervieweeNotFoundException ex,
			WebRequest request) {
	...
	public final ResponseEntity<Object> handleInterviewNotFoundException(ScheduledInterviewNotFoundException ex,
			WebRequest request) {
