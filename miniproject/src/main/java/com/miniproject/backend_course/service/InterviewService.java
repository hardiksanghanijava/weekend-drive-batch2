...
public class InterviewService {
	...
	/*
	 * public Interview updateInterview(Interview interview) { Interview
	 * existingInterview =
	 * repository.findById(interview.getInterview_id()).orElse(null);
	 * existingInterview.setTime(interview.getTime());
	 * existingInterview.setStatus(interview.getStatus());
	 * existingInterview.setInterviewee(interview.getInterviewee()); return
	 * repository.save(existingInterview); }
	 */

	/*
	 * public Interview updateInterviewById(int id, Interview interview) { Interview
	 * interview1 = getInterviewById(id); if(interview1==null) { throw new
	 * ScheduledInterviewNotFoundException("id-"+id); }
	 * 
	 * 
